...
angular.module('corporateDashBoardApp')
  .controller('DataViewCtrl',['$filter', 'NgTableParams', function ($filter, NgTableParams) { //$filter, ngTableParams
    ...
    this.usersTable = new NgTableParams({
                ...
                getData: function ($defer, params) {
                    this.data = this.users.slice((params.page() - 1) * params.count(), params.page() * params.count());
